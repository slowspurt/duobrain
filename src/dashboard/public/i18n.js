...
const ko = {
  dashboardTitle: '대시보드', dashboardDescription: '',
  ...
  goals: '목표', people: '다음 단계', attention: '확인',
  noInference: '보이지 않는 활동이 있으면 기록되지 않았을 가능성이 있습니다.', delivery: '전송', peer: '확인', peerHint: '요청에서 확인',
  ...
  recordedWork: '기록', recordsDescription: '', period: '기간', days7: '7일', days30: '30일', allRecords: '전체',
  recentWork: '작업', blockers: '병목', timeSummary: '시간', participantTime: '사람', scopeTime: '범위',
  wikiTitle: '위키', wikiDescription: '', wikiView: '위키 보기', searchResults: '결과', dailyRefinement: '정리',
...
const en = {
  dashboardTitle: 'Dashboard', dashboardDescription: '',
  ...
  goals: 'Goal', people: 'Next step', attention: 'Check',
  noInference: 'Unseen activity may not have been recorded.', delivery: 'Delivery', peer: 'Check', peerHint: 'See request',
  ...
  recordedWork: 'Records', recordsDescription: '', period: 'Period', days7: '7 days', days30: '30 days', allRecords: 'All',
  recentWork: 'Work', blockers: 'Blocks', timeSummary: 'Time', participantTime: 'People', scopeTime: 'Scope',
  wikiTitle: 'Wiki', wikiDescription: '', wikiView: 'Wiki view', searchResults: 'Results', dailyRefinement: 'Refined',
